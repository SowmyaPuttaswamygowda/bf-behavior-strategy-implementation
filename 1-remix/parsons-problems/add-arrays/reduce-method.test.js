 import {addArrays}from './reduce-method.test.js'

 describe('addArrays function', function() {
  test('should return the sum of corresponding elements from two arrays of equal length', function() {
    ...
    test('should throw an error if input arrays have different lengths', function() {
        // Test case 4: Arrays of different lengths
        expect(() => { addArrays([1, 2], [3, 4, 5]) }).toThrowError(Error);
    });
});